...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spotifyStreamerBtn = (Button) findViewById(R.id.button_spotify_streamer);
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.button_spotify_streamer:
                    toast = Toast.makeText(context, R.string.toastMsgSpotify, Toast.LENGTH_LONG);
                    toast.show();
                    break;
                case R.id.button_scores_app:
                    toast = Toast.makeText(context, R.string.toastMsgScoresApp, Toast.LENGTH_LONG);                    toast.show();
                    break;
